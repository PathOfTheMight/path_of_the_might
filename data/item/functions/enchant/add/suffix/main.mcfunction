...
#タイプ分岐
execute if data block ~ ~ ~ {Items:[{Slot:0b,tag:{SubType:"Helmet"}}]} run function item:enchant/add/suffix/type/helmet/main
execute if data block ~ ~ ~ {Items:[{Slot:0b,tag:{SubType:"Chestplate"}}]} run function item:enchant/add/suffix/type/chestplate/main
#apply
