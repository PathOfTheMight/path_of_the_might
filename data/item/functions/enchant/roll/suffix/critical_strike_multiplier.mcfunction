execute if score #AffixLevel Number matches 8..20 run scoreboard players set #CurrentTier Number 6
execute if score #AffixLevel Number matches 21..29 run scoreboard players set #CurrentTier Number 5
