...
execute if score #PTotal Number matches 3 if score #STotal Number matches ..2 run scoreboard players set #SAdd Number 1
execute if score #PTotal Number matches ..2 if score #STotal Number matches 3 run scoreboard players set #PAdd Number 1
