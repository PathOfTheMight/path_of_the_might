...
execute if score #PCount Number matches 3 run scoreboard players set #CraftRand Number 1
execute if score #SCount Number matches 3 run scoreboard players set #CraftRand Number 0
