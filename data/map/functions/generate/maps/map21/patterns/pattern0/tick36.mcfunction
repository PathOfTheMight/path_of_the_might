...
setblock ~-32 41 ~-32 minecraft:structure_block{mode:LOAD,seed:103003}
...
setblock ~-16 41 ~-32 minecraft:structure_block{mode:LOAD,seed:63003}
...
setblock ~-32 41 ~-16 minecraft:structure_block{mode:LOAD,seed:113005}
