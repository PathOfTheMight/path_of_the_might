...
#(11 ,24)
data merge block -40691 1 -40700 {RecordItem:{tag:{StructureName:["minecraft:double/river_grass/quarter/pattern0"],Seed:701}}}
execute positioned ~16 ~ ~0 run function map:generate/structures/set_seed
#(12 ,21)
data merge block -40691 1 -40700 {RecordItem:{tag:{StructureName:["minecraft:double/grasspath_grass/three_quarter/pattern0","minecraft:double/grasspath_grass/three_quarter/pattern1","minecraft:double/grasspath_grass/three_quarter/pattern2","minecraft:double/grasspath_grass/three_quarter/pattern3"],Seed:704}}}
execute positioned ~-32 ~ ~16 run function map:generate/structures/set_seed
#(12 ,22)
