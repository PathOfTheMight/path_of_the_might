...
#setblock ~-32 41 ~-32 minecraft:structure_block{mode:LOAD,seed:10011}
...
#setblock ~-16 41 ~-32 minecraft:structure_block{mode:LOAD,seed:10011}
...
#setblock ~0 41 ~-32 minecraft:structure_block{mode:LOAD,seed:55}
