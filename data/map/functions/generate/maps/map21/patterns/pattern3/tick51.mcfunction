...
setblock ~-32 41 ~-32 minecraft:structure_block{mode:LOAD,seed:92}
...
setblock ~-16 41 ~-32 minecraft:structure_block{mode:LOAD,seed:83}
...
setblock ~0 41 ~-32 minecraft:structure_block{mode:LOAD,seed:83}
execute positioned ~0 41 ~-32 run function map:generate/structures/set_seed
#(25 ,12)
execute positioned ~16 41 ~-32 run function map:generate/structures/reset_chunk
setblock ~16 41 ~-32 minecraft:structure_block{mode:LOAD,seed:24}
execute positioned ~16 41 ~-32 run function map:generate/structures/set_seed
#(26 ,9)
