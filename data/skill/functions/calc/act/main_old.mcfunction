...
execute if score #ActiveSlot Number matches 0 run data modify entity 00000000-0000-0000-0000-0000000000 ArmorItems[3].tag.ActiveGem set from entity 00000000-0000-0000-0000-0000000000 ArmorItems[3].tag.Gems[0]
execute if score #ActiveSlot Number matches 1 run data modify entity 00000000-0000-0000-0000-0000000000 ArmorItems[3].tag.ActiveGem set from entity 00000000-0000-0000-0000-0000000000 ArmorItems[3].tag.Gems[1]
execute if score #ActiveSlot Number matches 2 run data modify entity 00000000-0000-0000-0000-0000000000 ArmorItems[3].tag.ActiveGem set from entity 00000000-0000-0000-0000-0000000000 ArmorItems[3].tag.Gems[2]
execute if score #ActiveSlot Number matches 3 run data modify entity 00000000-0000-0000-0000-0000000000 ArmorItems[3].tag.ActiveGem set from entity 00000000-0000-0000-0000-0000000000 ArmorItems[3].tag.Gems[3]
execute if score #ActiveSlot Number matches 4 run data modify entity 00000000-0000-0000-0000-0000000000 ArmorItems[3].tag.ActiveGem set from entity 00000000-0000-0000-0000-0000000000 ArmorItems[3].tag.Gems[4]
execute if score #ActiveSlot Number matches 5 run data modify entity 00000000-0000-0000-0000-0000000000 ArmorItems[3].tag.ActiveGem set from entity 00000000-0000-0000-0000-0000000000 ArmorItems[3].tag.Gems[5]
execute if score #ActiveSlot Number matches 6 run data modify entity 00000000-0000-0000-0000-0000000000 ArmorItems[3].tag.ActiveGem set from entity 00000000-0000-0000-0000-0000000000 ArmorItems[3].tag.Gems[6]
#装備ステータスをロード
scoreboard players operation #ID Number = @s ID
execute positioned -40896 1 -40960 as @e[tag=StatusAEC,distance=..1] if score @s Number = #Slot Number if score @s ID = #ID Number run function skill:calc/act/aec/main
