...
data modify entity 00000000-0000-0000-0000-0000000000 Tags set from entity 00000000-0000-0000-0000-0000000000 ArmorItems[3].tag.Gem.Tags
###装備ステータスをロード
scoreboard players operation #ID Number = @s ID
execute as @e[tag=StatusAEC,x=-40896,y=1,z=-40960,distance=..1] if score @s Number = #Equipment Number if score @s ID = #ID Number run function skill:calc/act/load/main
