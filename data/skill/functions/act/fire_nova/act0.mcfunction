data merge block -40691 1 -40700 {RecordItem:{tag:{Skill:{Tags:[Active,Spell,TypeFire,BaseFire,Area]}}}}
#Rng
...
summon minecraft:armor_stand ~ ~ ~ {Tags:[Skill,Spell,Area,FireNova,UniqueTick,Rotate,Rotate37,New],Invisible:1b,Silent:1b,Small:1b,Marker:1b}
