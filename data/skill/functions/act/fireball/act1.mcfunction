summon minecraft:armor_stand ^ ^1 ^0.5 {Tags:[Skill,Spell,SingleTarget,KillOnFin,Fireball,UniqueTick,Move,Unslide,New,NewMult],ArmorItems:[{},{},{},{id:"minecraft:brick",Count:1b}],Invisible:1b,Silent:1b,Small:1b,ActiveEffects:[{Id:28b,Amplifier:0b,Duration:200000000,ShowParticles:0b}]}
...
execute if score #Temp Mult matches -1 as @e[tag=Fireball,distance=..2,tag=New] run function skill:act/fireball/act2
execute if score #Temp Mult matches 0.. run function skill:act/fireball/act1
