...
summon minecraft:armor_stand ~ ~ ~ {Tags:[Skill,Spell,Single,KillOnFin,Arc,UniqueHit,Move,Reflect,Time,New],Invisible:1b,Silent:1b,Small:1b,ActiveEffects:[{Id:28b,Amplifier:0b,Duration:200000000,ShowParticles:0b}]}
