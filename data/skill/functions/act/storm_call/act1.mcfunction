...
execute if score #Flag Number matches 0 run summon minecraft:armor_stand ~ ~ ~ {Tags:[Skill,StormCall,StormCall1,Rotate,Rotate3,New],NoGravity:1b,Invisible:1b,Silent:1b,Small:1b,Marker:1b}
