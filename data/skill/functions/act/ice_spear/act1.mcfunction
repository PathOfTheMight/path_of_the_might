execute if entity @s[y_rotation=0..90] run summon minecraft:armor_stand ^ ^1 ^0.5 {Tags:[Skill,Spell,SingleTarget,KillOnFin,IceSpear,UniqueTick,Unslide,New],Rotation:[45f,0f],ArmorItems:[{},{},{},{id:"minecraft:cyan_dye",Count:1b}],Invisible:1b,Silent:1b,Small:1b,ActiveEffects:[{Id:28b,Amplifier:0b,Duration:200000000,ShowParticles:0b}]}
execute if entity @s[y_rotation=90.001..180] run summon minecraft:armor_stand ^ ^1 ^0.5 {Tags:[Skill,Spell,SingleTarget,KillOnFin,IceSpear,UniqueTick,Unslide,New],Rotation:[135f,0f],ArmorItems:[{},{},{},{id:"minecraft:cyan_dye",Count:1b}],Invisible:1b,Silent:1b,Small:1b,ActiveEffects:[{Id:28b,Amplifier:0b,Duration:200000000,ShowParticles:0b}]}
