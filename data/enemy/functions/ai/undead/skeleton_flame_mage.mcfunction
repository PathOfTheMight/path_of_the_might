...
execute if score #Flag Number matches 0 store success score #Flag Number facing entity @e[limit=1,sort=random,tag=Player,distance=..12] feet run function skill:act/fireball/act0
