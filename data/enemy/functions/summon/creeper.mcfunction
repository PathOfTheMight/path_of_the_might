...
execute if block ^2.27 ^ ^-0.11 #main:canspawn run summon minecraft:creeper ^2.27 ^ ^-0.11 {CustomName:'{"text":"クリーパー"}',Tags:[New,Husk,Time-,Mob,Enemy,Undead],Attributes:[{Name:generic.maxHealth,Base:1000000},{Name:generic.followRange,Base:48}],Health:1000000.0f,DeathLootTable:"minecraft:empty",DeathTime:19s}
...
execute if block ^-1 ^ ^3.28 #main:canspawn run summon minecraft:creeper ^-1 ^ ^3.28 {CustomName:'{"text":"クリーパー"}',Tags:[New,Husk,Time-,Mob,Enemy,Undead],Attributes:[{Name:generic.maxHealth,Base:1000000},{Name:generic.followRange,Base:48}],Health:1000000.0f,DeathLootTable:"minecraft:empty",DeathTime:19s}
