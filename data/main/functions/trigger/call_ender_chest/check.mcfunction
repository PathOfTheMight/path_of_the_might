...
execute store success score #Flag Number unless entity @e[tag=UI,limit=1,distance=..7] if block ~ ~ ~ #main:canspawn run function main:trigger/call_ender_chest/success
