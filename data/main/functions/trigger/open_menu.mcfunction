...
replaceitem entity @s armor.head minecraft:leather_helmet{Head:1b,AttributeModifiers:[{AttributeName:"generic.maxHealth",Name:"generic.maxHealth",Amount:0,Operation:0,UUIDLeast:1,UUIDMost:1,Slot:"head"},{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,Operation:0,UUIDLeast:1,UUIDMost:2,Slot:"head"},{AttributeName:"generic.movementSpeed",Name:"generic.movementSpeed",Amount:0,Operation:0,UUIDLeast:1,UUIDMost:3,Slot:"head"}]} 1
