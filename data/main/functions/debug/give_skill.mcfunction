...
give @p minecraft:iron_sword{HideFlags:17,ench:[{id:0,lvl:1}],display:{Name:'{"text":"通常攻撃\",\"italic\":false,\"color\":\"aqua"}',Lore:["§fタイプ:§b技能","§f手持ちの武器で攻撃する"]}}
give @p minecraft:fire_coral_fan{FireNova:1b,HideFlags:17,ench:[{id:0,lvl:1}],display:{Name:'{"text":"ファイアノヴァ\",\"italic\":false,\"color\":\"aqua"}',Lore:["§fタイプ:§b魔法§f・§c火§f・§b範囲","§f燃え盛る炎のノヴァを放つ"]}}
give @p minecraft:tube_coral_fan{IceNova:1b,HideFlags:17,ench:[{id:0,lvl:1}],display:{Name:'{"text":"アイスノヴァ\",\"italic\":false,\"color\":\"aqua"}',Lore:["§fタイプ:§b魔法§f・§9氷§f・§b範囲","§f凍える氷のノヴァを放つ"]}}
give @p minecraft:horn_coral_fan{ShockNova:1b,HideFlags:17,ench:[{id:0,lvl:1}],display:{Name:'{"text":"ショックノヴァ\",\"italic\":false,\"color\":\"aqua"}',Lore:["§fタイプ:§b魔法§f・§e雷§f・§b範囲","§f周囲に雷のリングを詠唱し","§f続けてより広い範囲に放電を起こす","§fそれぞれ範囲内の敵に雷ダメージを与える"]}}
